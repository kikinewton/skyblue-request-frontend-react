      ...
      <AppLayout 
        ...
        subNav={(
          ...
          >
            ...
            {userHasAnyRole(authUser.role, [EMPLOYEE_ROLE.ROLE_ADMIN, EMPLOYEE_ROLE.ROLE_PROCUREMENT_MANAGER]) && (
      ...
      >
        <Switch>
          ...
          <AuthenticatedRoute
            ...
            roles={[EMPLOYEE_ROLE.ROLE_ADMIN, EMPLOYEE_ROLE.ROLE_PROCUREMENT_MANAGER]} 
            {...props}
          />
