...
export const COMMENT_PROCESS_VALUES = {
  ...
  STORE_MANAGER_GRN_REVIEW: 'STORE_MANAGER_GRN_REVIEW',
  STORE_OFFICER_RESPONSE_TO_MANAGER_REVIEW: 'STORE_OFFICER_RESPONSE_TO_MANAGER_REVIEW',
  STORE_OFFICER_COMMENT: 'STORE_OFFICER_COMMENT',
}
